...
public class MainActivity extends AppCompatActivity {
    ...
    public void add()
    {
        ...
        String namaproduk = ed1.getText().toString();
        int harga = Integer.parseInt(ed2.getText().toString());
        int qty = Integer.parseInt(ed3.getText().toString());
        tot = harga * qty;

        data.add(namaproduk);
        data1.add(String.valueOf(harga));
